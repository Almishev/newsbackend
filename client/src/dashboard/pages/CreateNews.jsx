        ...
        <div className='bg-white rounded-md'>
            ...
            <div className='p-4'>
                <form onSubmit={added} >
                    ...
                    <div className='flex flex-col gap-y-2 mb-6'>
                        <label className='text-md font-medium text-gray-600' htmlFor="subcategory">Подкатегория</label>
                        <select
                            id="subcategory"
                            name="subcategory"
                            value={subcategory}
                        ...
                        >
                            <option value="">Избери подкатегория (по подразбиране: Новини)</option>
                            <option value="Прогнози">Прогнози</option>
                            <option value="Новини">Новини</option>
                            <option value="Трансфери">Трансфери</option>
                            <option value="Коментари">Коментари</option>
                        </select>
                    </div>
                    <div className='mt-4'>
