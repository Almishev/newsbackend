...
class newsController {
    add_news = async (req, res) => {
        ...
        try {
            ...
            const subcategory = fields.subcategory && fields.subcategory[0] ? fields.subcategory[0] : 'Новини';
            ...
            const subcategory_slug = subcategorySlugMap[subcategory] || 'novini';
    ...
    get_category_subcategory_news = async (req, res) => {
